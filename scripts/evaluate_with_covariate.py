...
RESULTS_PATH = Path(r"D:\scRNA_benchmark\benchmark_results\all_de_results_with_covariate.csv")
...
if len(metrics_df) == 0:
    print("\n没有生成任何可评估结果。")
    metrics_df.to_csv(OUT_DIR / "benchmark_metrics_with_covariate.csv", index=False)
